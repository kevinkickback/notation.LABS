...
describe('CharacterSearchDialog', () => {
    ...
    it('renders and performs a search', async () => {
        ...
        expect(screen.getByPlaceholderText(/search for a character/i)).not.toBeNull();
        // Simulate user typing and searching
        fireEvent.change(screen.getByPlaceholderText(/search for a character/i), { target: { value: 'Ken' } });
