...
- Improved update-check feedback so failures show a clear status message
- Update download progress window can now be dismissed after cancellation or errors
